  ...
  <div class="container">
    <div class="hero">
      <h1 class="hero-heading">
        <span>Is one slangroom contract not enough for you?</span>
        <span class="heading-gradient">Slangroom-chain!</span>
      </h1>
      ...
      <a class="video-backdrop" href="/slangroom-chain/description" target="_blank">
        ...
        <div class="try-link-container">
          <div class="try-link">Learn more →</div>
        </div>
      </a>
    </div>
  </div>
  ...
  <div class="container">
    <div style="display: flex; justify-content: center">
      <div class="start-link">
        <a href="dyne.org/slangroom">Learn more about Slangroom</a>
      </div>
    </div>
